...
function getAttractions() {
  ...
  axios({
    method: "get",
    url: `https://ptx.transportdata.tw/MOTC/v2/Tourism/Activity/${city}?$select=Name%2CAddress%2CCharge%2CPhone%2CPicture%2CDescription%2CWebsiteUrl%2CStartTime%2CEndTime%2CClass1&$filter=contains(Class1%2C'${type}')&$top=3&$format=JSON`,
    headers: GetAuthorizationHeader(),
  })
    .then((res) => {
      const data = res.data;
