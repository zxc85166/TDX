      ...
      <div class="navbar shadow-lg bg-neutral text-neutral-content" v-if="$route.meta.title">
        ...
        <div class="hidden px-2 mx-2 navbar-center lg:flex">
          <div class="flex items-stretch">
            <router-link to="Soojin" class="btn btn-ghost btn-sm rounded-btn">台灣景點</router-link>
            <router-link to="Jiyoon" class="btn btn-ghost btn-sm rounded-btn">美食住宿</router-link>
            <router-link to="Monday" class="btn btn-ghost btn-sm rounded-btn">景點交通</router-link>
          </div>
        </div>
